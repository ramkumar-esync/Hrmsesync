                        ...
                        <td style="padding:32px;">
                            ...
                            @if ($approved)
                                <p style="margin:0 0 16px; font-size:15px; line-height:1.6; color:#3a3f45;">
                                    Your leave request has been <strong style="color:#0f7a3d;">approved</strong>.
                                </p>
                            @else
                                <p style="margin:0 0 16px; font-size:15px; line-height:1.6; color:#3a3f45;">
                                    Your leave request was <strong style="color:#b3402f;">not approved</strong>.
                                </p>
                            @endif
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f7f8f6; border:1px solid #e4e6e1; border-radius:8px; margin:8px 0 20px;">
                                <tr>
                                    <td style="padding:16px 20px;">
                                        ...
                                        <p style="margin:0 {{ $note ? '0 14px' : '0' }}; font-size:15px; font-family:'SF Mono',Menlo,Consolas,monospace; color:#1c1f24;">{{ $dates }}</p>
                                        @if ($note)
                                            <p style="margin:0 0 4px; font-size:11px; text-transform:uppercase; letter-spacing:0.06em; color:#6b7280;">Note from HR</p>
                                            <p style="margin:0; font-size:15px; line-height:1.5; color:#3a3f45;">{{ $note }}</p>
                                        @endif
                                    </td>
                                </tr>
                            </table>

                            <a href="{{ $appUrl }}/leave" style="display:inline-block; background:#0f4c48; color:#ffffff; text-decoration:none; font-size:15px; font-weight:600; padding:12px 24px; border-radius:8px;">
                                View my leave
                            </a>
                        </td>
                    </tr>
